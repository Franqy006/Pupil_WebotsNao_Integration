...
from pupil_ros_plugin.msg import gaze_positions, gaze
#, pupil, pupil_positions, surface_position
...
#                gaze_position = loads(zmq_raw_msg)
...
#                    world_img_msg = cv2.cvtColor(world_image_msg, cv2.COLOR_BGR2GRAY)
